    ...
    <div className="w-[100%] flex h-screen  justify-between ">
      <div className=" hidden md:block md: md:basis-[30%] lg:basis-[20%] w-[100%] h-screen overflow-y-auto">
        <div className="overflow-y-scroll scrollbar-hide flex items-center wrap  h-screen flex-col relative">
          <NavLink
            to=""
            className="absolute top-8 2xl:top-12 text-xl 2xl:text-2xl text-zinc-600  z-[20000]"
          >
          ...
          <div className="footer flex flex-col mb-1">
            <p
              className="text-[#537d3d] px-0 2xl:px-8 md:px-6 lg:px-4 md:text-xl lg:text-xl relative z-50 uppercase tracking-tighter font-bold sm:text-left text-lg 2xl:text-5xl 2xl:pl-20 text-center w-full 
         mb-4 flash-element"
            >
              Hello, {details?.full_name?.split(" ")[0]}
            </p>
            <p
              className="text-[#537d3d] px-0 2xl:px-8 md:px-6 lg:px-4 md:text-xl lg:text-xl relative z-50 uppercase tracking-tighter font-bold sm:text-left text-lg 2xl:text-5xl 2xl:pl-20 text-center w-full 
         mb-4 flash-element"
            ...
            <p
              className="whitespace-normal relative z-50 flex md:text-md text-center  overflow-hidden break-words lg:text-md  2xl:text-4xl text-[#537d3d] w-full text-[12px] md:pl-1 uppercase font-bold 2xl:mt-6 2xl:mb-12
        mb-4"
            >
          ...
          <div className="hero-footerflex  flex-col justify-center z-10">
            <div className=" w-48 md:w-40 justify-self-center lg:w-40 xl:w-28 2xl:w-64 ">
              <img
                src={enfoni}
                alt="enfoni-logo "
                className="object-cover block mx-auto w-full"
              />
            </div>
          </div>
          <div
            className="kente absolute bottom-0 w-full bg-no-repeat bg-cover"
            style={{ backgroundImage: imageUrl }}
          >
            <img
              src={Kentecloth}
              alt=""
              className="object-cover w-full h-full block  mx-auto mix-blend-darken"
            />
          </div>
        </div>
      </div>
