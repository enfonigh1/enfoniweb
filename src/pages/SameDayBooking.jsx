...
const SameDayBooking = () => {
  ...
  const handlePaymentClick = (e) => {
    e.preventDefault();
    // disptach(payerInfo({ full_name, frames }));
                ...
                <>
                  <form className="flex flex-col justify-center items-center text-green">
                    ...
                    <p className="text-center">
                      <span className="font-bold">NOTE</span>: If you received a
                      payment prompt on your phone direct please use the button
                      below to check your code{" "}
                    </p>
                  </form>
