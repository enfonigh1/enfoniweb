     ...
     <h2 className="bg-[#537d3d] items-center rounded-tl-2xl  flex font-[poppins] py-1 pl-5 text-white"><BiSolidCaretLeftCircle onClick={() => handleProfile('back')} className="cursor-pointer mr-3" />Personal Information</h2>
      <form action="" className="px-5 ">
        ...
        <div className=" my-1 flex flex-col">
          ...
          <div className=" relative"><input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="hisemail@gmail.com" className="w-full  border-2 mt-2 pl-3 pr-7 py-1 font-['inter] rounded-2xl border-black outline-0 placeholder:font-['inter']" /><BiPencil className="absolute right-1 bottom-2"/></div>
        </div>
        <div className=" my-3 flex flex-col">
